...
func createX509(c *awskms.KMS) error {
	...
	root := &x509.Certificate{
		...
		Issuer:                pkix.Name{CommonName: "Amada Weld Tech Root"},
		Subject:               pkix.Name{CommonName: "Amada Weld Tech Root"},
	...
	intermediate := &x509.Certificate{
		...
		MaxPathLenZero:        true,
		Issuer:                root.Subject,
		Subject:               pkix.Name{CommonName: "Amada Weld Tech Intermediate"},
		SerialNumber:          mustSerialNumber(),
		SubjectKeyId:          mustSubjectKeyID(resp.PublicKey),
	}
